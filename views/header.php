...
<html lang="en">
  ...
  <body>
    <header>
      <div id="entete">
        <div id="logo"><a class="logo" href="https://pinterestvikenima.herokuapp.com/index.php"><img src="assets/logo/logo _vikenima_texte.png" alt="Logo VIKENIMA"></a></div>

        <form class="form_search" action="" method="post">
          <input type="search" name="" value="" placeholder="Tapez votre recherche ici ..." style="width: 400px;" >
